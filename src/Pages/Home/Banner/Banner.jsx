...
const Banner = () => {
    return (
        <div className="carousel w-full mt-6 h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute flex justify-end transform -translate-y-1/2 right-5 bottom-0">
                    <a href="#slide4" className="btn btn-circle mr-4 bg-red-500">❮</a>
            ...
            <div id="slide2" className="carousel-item relative w-full">
                ...
                <div className="absolute flex justify-end transform -translate-y-1/2 right-5 bottom-0">
                    <a href="#slide1" className="btn btn-circle mr-4 bg-red-500">❮</a>
            ...
            <div id="slide3" className="carousel-item relative w-full">
                ...
                <div className="absolute flex justify-end transform -translate-y-1/2 right-5 bottom-0">
                    <a href="#slide2" className="btn btn-circle mr-4 bg-red-500">❮</a>
            ...
            <div id="slide4" className="carousel-item relative w-full">
                ...
                <div className="absolute flex justify-end transform -translate-y-1/2 right-5 bottom-0">
                    <a href="#slide3" className="btn btn-circle mr-4 bg-red-500">❮</a>
